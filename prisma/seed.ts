...
},
{
  ...
  tags: ["Party", "Strategy"],
  description: "A social deduction game where players work together while trying to find impostors.",
  imageUrl: "/gamesLib/amongus.png",
},
{
  title: "Fall Guys",
  developer: "Mediatonic",
  platform: "PC / PlayStation / Xbox / Switch",
  tags: ["Party", "Competitive"],
  description: "A chaotic multiplayer party game with obstacle courses and mini-games.",
...
},
{
  ...
  description: "A fast-paced arena shooter with classic Halo gameplay and modern mechanics.",
  imageUrl: "/gamesLib/haloinfinite.png",
},
{
...
},
{
  ...
  platform: "PC / PlayStation / Xbox / Switch",
  tags: ["MOBA", "Strategy", "Competitive"],
  description: "A third-person MOBA where players control gods from various mythologies.",
...
},
{
  ...
  description: "An asymmetrical multiplayer horror game where survivors try to escape a killer.",
  imageUrl: "/gamesLib/dbd.png",
},
{
  title: "Phasmophobia",
...
},
{
  ...
  description: "A harsh survival game focused on crafting, base building, and PvP.",
...
},
{
  ...
  description: "A free-to-play platform fighting game with online multiplayer.",
